...
CREATE INDEX idx_leads_assigned_seller ON leads(assigned_seller);
CREATE INDEX idx_leads_product_stage ON leads(product, stage);
CREATE INDEX idx_visits_guide_date ON visits(guide_id, date);
CREATE INDEX idx_visits_lead_date ON visits(lead_id, date);
CREATE INDEX idx_contracts_lead ON contracts(lead_id);
CREATE INDEX idx_contracts_status ON contracts(status);
CREATE INDEX idx_contracts_doc_key ON contracts(clicksign_doc_key);
CREATE INDEX idx_payments_lead ON payments(lead_id);
CREATE INDEX idx_payments_tx ON payments(openpix_transaction_id);
